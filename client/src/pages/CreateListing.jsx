        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className=" p-3 border border-green-700 text-green-700 font-semibold uppercase rounded hover:shadow-lg disabled:opacity-80  "
            >
          ...
          <button
            ...
            className="rounded-lg p-3 bg-slate-700 text-white hover:opacity-95 disabled:opacity-80"
          >
